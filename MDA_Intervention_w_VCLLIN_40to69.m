function [MfPrevStore,MBRArray,L3Array] = ...
    MDA_Intervention_w_VCLLIN_40to69(beta,alpha,k0,kLin,k1,r1,sigma1,psi1,...
...
sumM=sumMf40to69(m2(39*12+1:69*12),ageMthMax,da,demog);
...
%     MfPrevStore(1,iTime+1)=100*mfAgeprevFun(sumM,negBinshapeFun(sumM,k0,kLin));
     ...
     MfPrevStore(1,iTime+1) = 100*mfAgeprevFun(sumMf40to69(mVec(39*12+1:69*12),ageMthMax,da,demog),...
                negBinshapeFun(sumMf40to69(mVec(39*12+1:69*12),ageMthMax,da,demog),k0,kLin));

    % Set the dummy variable arrays to store the current values so
    % that they can be used as the initial conditions for the next
    % timestep.
    p2=pVec;
    w2=wVec;
    m2=mVec;
