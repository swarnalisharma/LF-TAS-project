...
%                  WormKill = 0.55+ 0.0*rand(length(mfPrevArray(1,:)),1);  % for IDA
        ...
        EP_Th_TBR(1:6,3)=[0.031017, 0.041388, 0.018659, 0.037083, 0.007987, 0.065918];
        ...
        tWHO = Time_toCross_below_Threshold(mfPrevIntv1,1);
            
            tWHO2 = Time_toCross_below_Threshold_mean(mfPrevIntv1,EP_Th_TBR(iReg,i));
             tWHO3 = Time_toCross_below_Threshold_mean(mfPrevIntv1,1);
            tWHO1 = Time_toCross_below_Threshold(mfPrevIntv1,EP_Th_TBR(iReg,i)); % finds month where 1% is reached
...
%             %     p=find(mfPrevIntv3(tWHO1,:)<=EP_Th_ABR(iReg));
    ...
    prec6 = round(length(id7)/(length([id7,id8]))*100);
            ...
            save(sprintf('Intv_MDAanVC_EP_new_%s.mat',char(Sites{iSites})),...
                'mfPrevIntv1','MBRIntv1','L3Intv1','RegimenEfficacy',...
                'MonthlyMDACov','IRSCoverages',...
                'ITNCoverages','MfData','SwitchMonth','mfPrevIntv3',...
                'MBRIntv3','L3Intv3','tWHO1','tWHO3','WormKill','prec1','prec2','prec3','prec4','prec5','prec6','id1','id2','id3','id4','id5','id6','id7','id8','tWHO','tWHO2');
        end
