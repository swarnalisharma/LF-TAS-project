function [MfPrevStore,CfaPrevStore,MBRArray,L3Array] = ...
    MDA_Intervention_w_VCLLIN_6to7_cfa(beta,alpha,k0,kLin,k1,r1,sigma1,psi1,...
...
sumM=sumMf6to7(m2(5*12+1:7*12),ageMthMax,da,demog);
MfPrevStore(1,1)=100*mfAgeprevFun(sumM,negBinshapeFun(sumM,k0,kLin));
sumC = sumMf6to7(c2(5*12+1:7*12),ageMthMax,da,demog);
CfaPrevStore(1,1) = 100*mfAgeprevFun(sumC,negBinshapeFun(sumC,k0,kLin));
...
%     MfPrevStore(1,iTime+1)=100*mfAgeprevFun(sumM,negBinshapeFun(sumM,k0,kLin));
     ...
     MfPrevStore(1,iTime+1) = 100*mfAgeprevFun(sumMf6to7(mVec(5*12+1:7*12),ageMthMax,da,demog),...
                negBinshapeFun(sumMf6to7(mVec(5*12+1:7*12),ageMthMax,da,demog),k0,kLin));
sumC = sumMf6to7(cVec(5*12+1:7*12),ageMthMax,da,demog);
