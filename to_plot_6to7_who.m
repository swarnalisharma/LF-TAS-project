...
stick5 = round(length(f)/(length([eli1,eli2]))*100);
 save(sprintf('Intv_WHO_MDA_6to7_info_%s.mat',char(Sites{iSites})),...
...
% subplot(2,3,2)
% load('Intv_WHO_MDA_Missasso.mat')
% semilogy((1:length(mfPrevIntv3(:,1)))/12,(mfPrevIntv3(:,:)),'Color','b');
% hold on;
% % semilogy((1:length(mfPrevIntv3(1:((((tWHO-1)/12)+5)*12),1)))/12,(mfPrevIntv3(1:((((tWHO-1)/12)+5)*12),id5)),'r');
% % hold on;
% % semilogy((132:length(mfPrevIntv3(1:421,1)))/12,(mfPrevIntv3(132:421,id3)),'g');
% % hold on;
% % semilogy((132:length(mfPrevIntv3(1:421,1)))/12,(mfPrevIntv3(132:421,id1)),'r');
% % hold on;
% id10=[];
% 
% for i=1:length(mfPrevIntv3(1,:))
%     for j=tWHO:421
%         if(mfPrevIntv3(j-1,i)<mfPrevIntv3(j,i) && mfPrevIntv3(421,i)>0.000750 && mfPrevIntv3(j-1,i)<mfPrevIntv3(421,i))
%             id10(i)=j-1;
%            break;
%         end
%     end
...
%     if (id10(i)~=0)
% %         break;
%     semilogy((id10(i):length(mfPrevIntv3(:,1)))/12,(mfPrevIntv3(id10(i):end,i)),'Color','r');
%     end
% hold on;
% end
% 
...
% for i=1:length(mfPrevIntv3(1,:))
%     for j=tWHO:421
%         if(mfPrevIntv3(j-1,i)>mfPrevIntv3(j,i) && mfPrevIntv3(421,i)<0.000750)
%             id(i)=j-1;
%            break;
%         end
%     end
...
%     if (id(i)~=0)
% %         break;
%     semilogy((id(i):length(mfPrevIntv3(:,1)))/12,(mfPrevIntv3(id(i):end,i)),'Color','g');
%     end
% hold on;
% end
% hold on;
% plot([0 35],[1 1],'--k');
% hold on;
% plot([0 35],[0.000750 0.000750],'--b');
% hold on;
% plot([((tWHO-1)/12) ((tWHO-1)/12)],[10^-10 10^2],'--k');
% hold on;
% plot([((tWHO-1)/12)+5 ((tWHO-1)/12)+5],[10^-10 10^2],'--b');
% hold on;
% set(gca,"XLim",[0 35]);
% set(gca,"YLim",[10^-10 100]);
% hold on;
% xlabel("No. of years");
% ylabel("Mf prevalence(%)");
% hold on;
% 
% subplot(2,3,3)
% load('Intv_WHO_MDA_Peneng.mat')
% semilogy((1:length(mfPrevIntv3(:,1)))/12,(mfPrevIntv3(:,:)),'Color','b');
% hold on;
% % semilogy((1:length(mfPrevIntv3(1:((((tWHO-1)/12)+5)*12),1)))/12,(mfPrevIntv3(1:((((tWHO-1)/12)+5)*12),id5)),'r');
% % hold on;
% % semilogy((1:length(mfPrevIntv3(1:((((tWHO-1)/12)+5)*12),1)))/12,(mfPrevIntv3(1:((((tWHO-1)/12)+5)*12),id7)),'g');
% % hold on;
% % semilogy((228:length(mfPrevIntv3(1:421,1)))/12,(mfPrevIntv3(228:421,id3)),'g');
% % hold on;
% % semilogy((228:length(mfPrevIntv3(1:421,1)))/12,(mfPrevIntv3(228:421,id1)),'r');
% % hold on;
% id10=[];
% 
% for i=1:length(mfPrevIntv3(1,:))
%     for j=tWHO:421
%         if(mfPrevIntv3(j-1,i)<mfPrevIntv3(j,i) && mfPrevIntv3(421,i)>0.004534 && mfPrevIntv3(j-1,i)<mfPrevIntv3(421,i))
%             id10(i)=j-1;
%            break;
%         end
%     end
...
% for i=1:length(mfPrevIntv3(1,:))
%     for j=tWHO:421
%         if(mfPrevIntv3(j-1,i)>mfPrevIntv3(j,i) && mfPrevIntv3(421,i)<0.004534)
%             id(i)=j-1;
%            break;
%         end
%     end
...
% 
% subplot(2,3,4)
% load('Intv_WHO_MDA_Piapung.mat')
% semilogy((1:length(mfPrevIntv3(:,1)))/12,(mfPrevIntv3(:,:)),'Color','b');
% hold on;
% % semilogy((1:length(mfPrevIntv3(1:((((tWHO-1)/12)+5)*12),1)))/12,(mfPrevIntv3(1:((((tWHO-1)/12)+5)*12),id5)),'r');
% % hold on;
% % semilogy((120:length(mfPrevIntv3(1:421,1)))/12,(mfPrevIntv3(120:421,id3)),'g');
% % hold on;
% % semilogy((120:length(mfPrevIntv3(1:421,1)))/12,(mfPrevIntv3(120:421,id1)),'r');
% % hold on;
% id10=[];
% 
% for i=1:length(mfPrevIntv3(1,:))
%     for j=tWHO:421
%         if(mfPrevIntv3(j-1,i)<mfPrevIntv3(j,i) && mfPrevIntv3(421,i)>0.001550 && mfPrevIntv3(j-1,i)<mfPrevIntv3(421,i))
%             id10(i)=j-1;
%            break;
%         end
%     end
...
% for i=1:length(mfPrevIntv3(1,:))
%     for j=tWHO:421
%         if(mfPrevIntv3(j-1,i)>mfPrevIntv3(j,i) && mfPrevIntv3(421,i)<0.001550)
%             id(i)=j-1;
%            break;
%         end
%     end
...
% % semilogy((1:length(mfPrevIntv3(1:((((tWHO-1)/12)+5)*12),1)))/12,(mfPrevIntv3(1:((((tWHO-1)/12)+5)*12),id7)),'g');
% % hold on;
% % semilogy((180:length(mfPrevIntv3(1:421,1)))/12,(mfPrevIntv3(180:421,id3)),'g');
% % hold on;
% % semilogy((180:length(mfPrevIntv3(1:421,1)))/12,(mfPrevIntv3(180:421,id1)),'r');
% % hold on;
% id10=[];
% 
% for i=1:length(mfPrevIntv3(1,:))
%     for j=tWHO:421
%         if(mfPrevIntv3(j-1,i)<mfPrevIntv3(j,i) && mfPrevIntv3(421,i)>0.001799 && mfPrevIntv3(j-1,i)<mfPrevIntv3(421,i))
%             id10(i)=j-1;
%            break;
%         end
%     end
...
% for i=1:length(mfPrevIntv3(1,:))
%     for j=tWHO:421
%         if(mfPrevIntv3(j-1,i)>mfPrevIntv3(j,i) && mfPrevIntv3(421,i)<0.001799)
%             id(i)=j-1;
%            break;
%         end
%     end
...
% % semilogy((1:length(mfPrevIntv3(1:((((tWHO-1)/12)+5)*12),1)))/12,(mfPrevIntv3(1:((((tWHO-1)/12)+5)*12),id7)),'g');
% % hold on;
% % semilogy((168:length(mfPrevIntv3(1:421,1)))/12,(mfPrevIntv3(168:421,id3)),'g');
% % hold on;
% % semilogy((168:length(mfPrevIntv3(1:421,1)))/12,(mfPrevIntv3(168:421,id1)),'r');
% % hold on;
% id10=[];
% 
% for i=1:length(mfPrevIntv3(1,:))
%     for j=tWHO:421
%         if(mfPrevIntv3(j-1,i)<mfPrevIntv3(j,i) && mfPrevIntv3(421,i)>0.001101 && mfPrevIntv3(j-1,i)<mfPrevIntv3(421,i))
%             id10(i)=j-1;
%            break;
%         end
%     end
...
% for i=1:length(mfPrevIntv3(1,:))
%     for j=tWHO:421
%         if(mfPrevIntv3(j-1,i)>mfPrevIntv3(j,i) && mfPrevIntv3(421,i)<0.001101)
%             id(i)=j-1;
%            break;
%         end
%     end
